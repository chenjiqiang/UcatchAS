...
public final class StringUtil {
	...
	/**
	 * TODO 在此写上方法的相关说明. <br>
	 * @author chenxiangbai 2012-6-29 下午4:19:32 <br>
	 */
	private StringUtil() {
	...
	// public static String assembleId(final StringBuilder sb,final String splite){
	//
	// }
	...
	/**
	 * 去除电话号码中带区号的“-”符号. <br>
	 * 比如：0756-1234567转换为07561234567
	 * 
	 * @author wangjun4 2014年4月1日 下午6:51:54 <br>
	 * @param telephone
	 *            带格式的电话号码，比如:0756-1234567
	 * @return string 去除格式的电话号码，可以直接拨号，比如：07561234567
	 */
	public static String escapeTelephoneSymbol(final String telephone) {
		String result = "";
		if (null != telephone && telephone.length() > 0) {
			result = telephone.trim();
			String[] telephoneSeg = result.split("-");
			if (null != telephoneSeg && telephoneSeg.length > 0) {
				result = "";
				for (String seg : telephoneSeg) {
					result += seg;
				}
			}
		}
