...
public class XListView extends ListView implements OnScrollListener {
	...
	private void startLoadMore() {
		/**
		 * 2015-10-22 刘欢
		 * 添加一个判断 如果上一次的加载更多 还有没有执行完的话 直接返回
		 */
		if(mPullLoading){
			return;
		}
    ...
    public void loadDefault() {
        updateHeaderHeight(300f / OFFSET_RADIO);
        invokeOnScrolling();
        mPullRefreshing = true;
        mHeaderView.setState(XListViewHeader.STATE_REFRESHING);
        if (mListViewListener != null) {
	...
	/**
	 * 执行头刷新 .
	 * @author wangguanwen 2014年10月30日 下午3:18:41 <br>  
	 */
	...
	/**
	 * 执行尾刷新 .
	 * @author wangguanwen 2014年10月30日 下午3:18:49 <br>  
	 */
	...
	/**
	 * 重写方法，达到使ListView适应ScrollView的效果 {@inheritDoc}
	 * 
	 * @see android.widget.ListView#onMeasure(int, int)
	 * @author wangjun4 2014年9月28日 下午5:43:19 <br>
	 */
	/*@Override
