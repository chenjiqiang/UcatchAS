...
import com.chen.ucatch.adapter.AttentionAdapter;
...
public class MyAttentionActivity extends MyBaseActivity implements OnClickListener{
					...
					case GET_LIST:
						List<UserVO> DataList = (List<UserVO>) com.alibaba.fastjson.JSONArray
								.parseArray(String.valueOf(vo.getData()),
										UserVO.class);
						if (DataList.size() <= 0) {
							Toast.makeText(mContext, "你目前还没有关注任何人~",
